...
const FullSphere = function () {
  ...
  return (
    <svg ref={svgRef} className="sphere" viewBox="0 0 255.6 342.2">
      ...
      <g id="Core" className="sphere__core sphere--hide">
        <path
      ...
      <g id="Top_Layer" className="sphere__top-blob-half sphere--hide">
        <path
          id="a-shape-5"
        ...
        />
        <path
          className="sphere__halves sphere--color sphere--stroke sphere--width-5"
          d="M212.9,61.7c4.3,6.5,23.5-9.6,27.8-3.9c2.4,3.2-8.1,13.5-9.4,15c-26.2,31.6,31.8-0.7,15.9,15.4
		c-20.6,20.9,1.6,14.1,2.1,19.3s-11.7,12.1-11.1,15.3c0.9,5.1,14.2,1.2,16.1,3.5c4.7,5.6-11.5,9-14.3,22.7c-0.7,3.3,2.2,3.8,8,10.2
		c4.4,4.9-7.1,0.8-12.4,6.3c-2.7,2.8-8.3,10.3-11.7,9.1c-8.2-2.9-7.9-6.4-16.2-5c-6.1,1-16,11.8-21.1,6.1
		c-8.6-9.7-18.4,8.1-25.8,7.4c-8.6-0.8-23.4-24.7-30.1-13.3c-10.6,18-17.4,4.3-25.8-2.4C93.6,158.5,72,178,57.3,156.7
		c-3.9-5.7-16.4,11.4-21.1,1.6c-2.5-5.1-6.1-8.8-11.4-6.3c-10.6,5.1-18.6,3.9-20.1,0.3c-3.9-9.7-0.8-13.7-3.9-23.2
		c-2.1-6.4,5.4-10.8,6.4-16.6c1.4-8.2-5.9-5.8-0.4-11.5c8.4-8.8,6.6-11.6,8.4-19.2c1.8-7.4,9.1-5.7,11.2-13
		c2.6-9.2,2.1-14.7,8.2-15.8c4.4-0.7,9.9-3.5,11.9-6c5.3-6.5,4.5-9.6,5-15.5c0.6-7.9,10.1,3.9,16.6,2c12.7-3.8,6.9-16.2,13.3-17
		c5-0.6,14.3,14,17.8,9.9c6.9-8,10.2-16.8,15.1-10.2c11.2,15.3,20.9,1.4,29.4-4.6s9.5,9.4,15.6,10.4c4.7,0.8,18.8-11.7,22.3-10.6
		c3.7,1.2-1.1,7.9,4.3,9.8c8.9,3.1,26.5-23,30.9-20.7c4.8,2.4-12.7,37-6.3,33.7C228,25.2,207.8,54,212.9,61.7z"
        />
        <g id="Upper_sphere_lines">
          <path
            id="a-136"
          ...
          <path
            id="a-80"
            className="sphere__thick-lines sphere--no-color sphere--stroke sphere--width-4"
          ...
          <path
            id="a-67"
            className="sphere--no-color sphere--stroke sphere--width-3ere--no-color sphere--stroke sphere--width-3"
      ...
      <g id="Bot_Layer" className="sphere__bot-blob-half sphere--hide">
        <path
          className="sphere__halves sphere--color sphere--stroke sphere--width-5"
          d="M4.7,217.4c-0.1,4.4,0.2,16.1,1.8,22.4c1.1,4.4,5.2,7.9,5.3,14.4c0.1,3.3-0.4,9,0.9,12
		c2.3,5.2,9.3,4.8,10.6,10.1c1.8,7-2.9,11.6-3.3,20.3c-0.4,9,9-4.5,11.4-2.1c5.7,6-8.6,27.6,3.1,19c10.1-7.4-5.7,23.8-2.7,27.6
		c2.5,3.3,12.4-9.5,23.1-18.8c7.4-6.5-0.5,12.1,6,14.4c5.7,2,15.8-14.5,25.3-4.2c2.3,2.5,5.5,5.9,12.1,6.3c6.3,0.4,16-6.6,23.5-6.3
		c6,0.3,17,2.7,22.6,2.1c7.5-0.8,9.5-5.8,16.2-7.8c8-2.5,17.8-1.6,24.6-5.6c6.1-3.5,10.3-12.4,15.5-16.8s13.8-6.2,18.1-11.4
		c3.9-4.6,4.4-13.1,7.4-17.9c3.5-5.5,8.1-9.1,10.6-14.6c3.3-7.4,6.4-20.8,5.5-27.5c-0.4-3.2-6,4.2-9.3,8.4c-3.4,4.3-5.2,4.9-8.4,3.9
		c-6.6-2.2-8.7-7.2-15.5-4.4s-10.7,6.6-17.2,7.7c-3.3,0.5-5.7-5.8-9.8-4.8c-9.4,2.2-15.5,13.4-22.3,9.4c-10.1-6-21.1-20.1-26.4-13.7
		c-0.8,0.9-2.5,5.1-6.4,8.4c-3.5,3-7.9,2.6-11.5-0.8c-10-9.7-10.3-11.2-17.2-11c-10.2,0.4-18.2,3.8-25.8,1.4
		c-14.5-4.6-11.3-10.9-15.8-10.8c-3.9,0.1-5.1,2.1-8.8,4c-4.3,2.1-8,1.7-9.6-2.3c-2.1-5.4-5.3-8.3-8.3-7.1
		c-9.2,3.5-9.1,4.9-14.1,5.1C6.4,227,5,209.4,4.7,217.4z"
        />
        <g id="Bottom_sphere_lines">
          <path
            id="b-69"
            className="sphere--no-color sphere--stroke sphere--width-3"
